...
INSTALLED_APPS = [
    ...
    'languages',
    'hotel',
    # 'movie',  # Movie catalog disabled in favor of Africana Ride.
    'social', 
    'logistics',
]
...
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'kintupeter7@gmail.com').strip()
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', '')
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'Africana AI <info@africanaai.info>').strip()
...
FEED_RANKING_MAX_POSTS = int(os.getenv('FEED_RANKING_MAX_POSTS', '500'))
FEED_MARKET_MAX_PRODUCTS = int(os.getenv('FEED_MARKET_MAX_PRODUCTS', '100'))
FEED_MARKET_MAX_JOBS = int(os.getenv('FEED_MARKET_MAX_JOBS', '100'))
