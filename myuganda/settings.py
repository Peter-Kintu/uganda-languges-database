...
# Allow all hosts when deployed, read from an environment variable
...
# This configuration will automatically use the DATABASE_URL environment variable
# on Render, and fall back to SQLite for local development.
# The conn_max_age=600 parameter is added for persistent connections, which
# is recommended for production environments like Render.
DATABASES = {
...
JAZZMIN_UI_TWEAKS = {
    ...
    "sidebar_nav_links_retina_style": False
}
