...
urlpatterns = [
    ...
    path('community/<int:community_id>/channels/create/', views.create_community_channel, name='create_community_channel'),
    path('community/<int:community_id>/notifications/', views.toggle_community_notifications, name='toggle_community_notifications'),
    ...
    path('record-impression/', views.record_feed_impression, name='record_feed_impression'),
